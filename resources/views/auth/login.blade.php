...
<body class="bg-dark">
    <div class="main-wrapper">
        ...
        <!-- Login box.scss -->
        <!-- ============================================================== -->
        <div class="auth-wrapper position-absolute top-50 start-50 translate-middle">
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    <div class="text-center pt-3 pb-3">
                        <span class="db">
                            {{-- <img src="{{ asset('TemplateAdmin') }}/assets/images/logo.png" alt="logo" /> --}}
                            <h2 class="text-light">Login</h2>
                        </span>
                    </div>
                    <!-- Form -->
                    <form class="form-horizontal mt-3" id="loginform" action="{{ route('login.action') }}"
                        method="POST">
                        @csrf
                        @if ($errors->any())
                        ...
                        <div class="row border-top border-secondary">
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="pt-3">
                                        <a class="btn btn-info" id="to-recover" href="/"><i class="fas fa-backward"></i> Kembali</a>
